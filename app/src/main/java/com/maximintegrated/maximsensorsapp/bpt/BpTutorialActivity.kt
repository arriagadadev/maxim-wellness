...
class BpTutorialActivity : AppIntro2() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addSlide(AppIntroFragment.newInstance(title = "Calibration", description = "Enter the 3 pairs of reference BP values and click START to collect PPG data. PPG signal will appear, keep measuring until the status turns to SUCCESS.", imageDrawable = R.drawable.tutorial3))

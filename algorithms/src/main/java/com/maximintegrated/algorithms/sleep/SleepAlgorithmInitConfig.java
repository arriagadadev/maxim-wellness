...
public class SleepAlgorithmInitConfig {
    ...
    public SleepAlgorithmInitConfig(DetectableSleepDuration detectableSleepDuration, SleepUserInfo userInfo, boolean restingHrAvailable, boolean confidenceLevelAvailableHr, boolean confidenceLevelAvailableIbi, boolean activityAvailable) {
    ...
    public SleepAlgorithmInitConfig() {
        ...
        userInfo = new SleepUserInfo(30, 70, SleepUserInfo.Gender.MALE, 70);
    }
    ...
    public SleepUserInfo getUserInfo() {
        return userInfo;
    }

    public void setUserInfo(SleepUserInfo userInfo) {
        this.userInfo = userInfo;
    }

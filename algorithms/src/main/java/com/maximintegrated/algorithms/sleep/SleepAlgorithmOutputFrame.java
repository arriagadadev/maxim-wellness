...
public class SleepAlgorithmOutputFrame {
    ...
    public void update(int sleepWakeDecisionStatus, int sleepWakeDecision, int sleepWakeDetentionLatency, float sleepWakeOutputConfLevel, int sleepPhaseOutputStatus, int sleepPhaseOutput, float sleepPhaseOutputConfLevel, float hr, float accMag, float ibi, int arrayLength, long dateInfo) {
        output.update(sleepWakeDecisionStatus, sleepWakeDecision, sleepWakeDetentionLatency, sleepWakeOutputConfLevel, sleepPhaseOutputStatus, sleepPhaseOutput, sleepPhaseOutputConfLevel, hr, accMag, ibi);
